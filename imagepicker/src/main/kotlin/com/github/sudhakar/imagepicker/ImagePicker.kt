...
import com.github.sudhakar.imagepicker.listener.ResultListener
import com.github.sudhakar.imagepicker.util.DialogHelper
import java.io.File
    ...
    class Builder(private val activity: Activity) {
        ...
        private fun getBundle(): Bundle {
            return Bundle().apply {
                ...
                putSerializable(EXTRA_CAMERA_DEVICE, imageProvider)
