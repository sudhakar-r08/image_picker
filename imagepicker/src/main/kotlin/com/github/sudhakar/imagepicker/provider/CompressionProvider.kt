package com.github.sudhakar.imagepicker.provider

import android.annotation.SuppressLint
import android.graphics.Bitmap
import android.net.Uri
import android.os.Bundle
import com.github.sudhakar.imagepicker.ImagePicker
import com.github.sudhakar.imagepicker.ImagePickerActivity
import com.github.sudhakar.imagepicker.util.ExifDataCopier
import com.github.sudhakar.imagepicker.util.FileUtil
import com.github.sudhakar.imagepicker.util.ImageUtil
...
class CompressionProvider(activity: ImagePickerActivity) : BaseProvider(activity) {
    ...
    private fun startCompressionWorker(uri: Uri) {
        ...
        GlobalScope.launch {
            var file = FileUtil.getTempFile(this@CompressionProvider, uri)
            if (file != null) {
                file = startCompression(file)
            }
            if (file != null) {
                // Post Result
                handleResult(file)
                ...
                // Post Error
                setError(com.github.sudhakar.imagepicker.R.string.error_failed_to_compress_image)
            }
        }
    }
